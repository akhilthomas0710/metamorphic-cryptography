...
}else
{
            ...
            String sql = "select * from login where uname='" + Login.cuname + "' and upass='" + cpass.getText() + "'";
            System.out.println(sql);
            ResultSet rs = db.getData(sql);
            if (rs.next()) {
                String sql1 = "update login set upass='" + npass.getText() + "' where uname='" + Login.cuname + "'";
                db.putData(sql1);
